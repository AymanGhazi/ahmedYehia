...
/**
 * The order is the order of the source deck — hand drawing first, then Lake View
 * B:16 and B:96, the Creativity Design apartments, and the two Painite units
 * last. Anyone who has seen the PowerPoint reads the site in the same sequence.
 */
